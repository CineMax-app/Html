...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function openPlayModal() {
    ...
    currentAction = 'play';
    modalIsOpen = true;
    // Solo agregamos al historial cuando se abre el modal
    history.pushState({ modalOpen: true }, '');
  }

  // Función para abrir el modal de transmisión
  function openTransmitModal() {
  ...
  function closeModalFunc() {
    ...
    // Reemplazamos el estado actual para que el botón atrás funcione correctamente
