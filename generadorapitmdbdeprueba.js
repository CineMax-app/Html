            ...
            try {
                ...
                for (let seasonNumber = 1; seasonNumber <= serieData.number_of_seasons; seasonNumber++) {
                    ...
                    for (const [index, episode] of seasonData.episodes.entries()) {
                        ...
                        const episodeHTML = `
                            <li>
                                <a href="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${episodeUrl}" class="" data-url="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${episodeUrl}">
