  ...
  <div class="image-and-btn">
    ...
    <div class="post-header__info"><br>
      ...
      <ul>
        ...
        <li class="info-item"><i class="fas fa-bolt fa-beat" style="color: #FFFF00;"></i> EXOPLAYER</li>
      </ul>
    </div>
  </div>
                ...
                if (respuesta.status === 200) {
                    ...
                    const modalOptions = [
                        userInputA ? `<a href="https://embed-cinemax-app.blogspot.com/p/embed.html?videoUrl=${userInputA}&secure_uri=true" class="modal-option" id="option1">
                            <i class="fas fa-bolt fa-beat"></i> CDN-ZEUSPLAYER HD
                        </a>` : '',
...
<li><i class="fas fa-bolt fa-beat" style="color: #FFFF00;"></i> EXOPLAYER</li>
</ul>
</div>
</div>
...
e.preventDefault();
modalTitle.textContent = 'Seleccionar Servidor';
