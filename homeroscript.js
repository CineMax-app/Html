            ...
            try {
                ...
                for (let seasonNumber = 1; seasonNumber <= serieData.number_of_seasons; seasonNumber++) {
                    ...
                    for (const [index, episode] of seasonData.episodes.entries()) {
                        ...
                        const episodeHTML = `
                            <li>
                                <a href="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${episodeUrl}" class="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${episodeUrl}" data-url="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${episodeUrl}">
...
/* Ocultar los botones sin eliminarlos */
#add-btn,
#remove-btn {
  display: none;
}
...
<div class="post-header">
  <div class="image-and-btn">
    <img src="https://image.tmdb.org/t/p/w300/${serieData.poster_path}" class="poster-img" alt="Merlina" />
    <div class="fav-js">
...
<!-- Ventana Modal Video -->
            ...
            try {
                ...
                if (respuesta.status === 200) {
                    ...
                    const modalOptions = [
                        userInputA ? `<a href="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${userInputA}&secure_uri=true" class="modal-option" id="option1">
                            <i class="fas fa-bolt fa-beat"></i> TurboEvid HD
                        </a>` : '',
                        userInputB ? `<a href="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${userInputB}&secure_uri=true" class="modal-option" id="option2">
                            <i class="fas fa-bolt fa-beat"></i> TurboWolf HD
                        </a>` : '',
                        userInputC ? `<a href="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${userInputC}&secure_uri=true" class="modal-option" id="option3">
                            <i class="fas fa-bolt fa-beat"></i> TurboWish HD
                        </a>` : '',
                        userInputD ? `<a href="https://video-cinemax-app.blogspot.com/p/loader.html?videoUrl=${userInputD}&secure_uri=true" class="modal-option" id="option4">
...
<li><i class="fas fa-bolt fa-beat" style="color: #FFFF00;"></i> TurboPlay</li>
</ul>
</div>
</div>
