        ...
        if (isSerie.checked) {
            ...
            try {
                ...
                if (respuesta.status === 200) {
                    ...
                    const modalOptions = [
                        userInputA ? `<a href="${userInputA}&secure_uri=true" class="modal-option" id="option1">
                            <i class="fas fa-play"></i> Latino - Supervideo SD
                        </a>` : '',
                        userInputB ? `<a href="${userInputB}&secure_uri=true" class="modal-option" id="option2">
                            <i class="fas fa-play"></i> Latino - Dropload SD
                        </a>` : '',
                        userInputC ? `<a href="${userInputC}&secure_uri=true" class="modal-option" id="option3">
