                ...
                if (respuesta.status === 200) {
                    ...
                    const modalOptions = [
                        userInputA ? `<a href="https://player-cinemax.ct.ws/app/supervideo.php?v=${userInputA}&secure_uri=true" class="modal-option" id="option1">
                            <i class="fas fa-play"></i> Latino - Supervideo SD
                        </a>` : '',
                        userInputB ? `<a href="https://player-cinemax.ct.ws/app/dropload.php?v=${userInputB}&secure_uri=true" class="modal-option" id="option2">
                            <i class="fas fa-play"></i> Latino - Dropload SD
                        </a>` : '',
                        userInputC ? `<a href="https://player-cinemax.ct.ws/app/filegram.php?v=${userInputC}&secure_uri=true" class="modal-option" id="option3">
                            <i class="fas fa-play"></i> Latino - Filegram HD
                        </a>` : ''
                    ].filter(Boolean).join('');
